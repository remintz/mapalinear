...
def upgrade() -> None:
    ...
    # Note: Keeping existing cache_entries, cache_stats, and google_places_cache tables as-is
    # The cache system will continue to use the existing table until fully migrated
