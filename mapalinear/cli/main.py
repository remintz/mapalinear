...
def search(
    ...
    # Usar o endpoint assíncrono
    console.print("[bold green]Iniciando busca de estradas...")
    try:
        ...
        console.print(f"[bold green]Buscando estradas entre [cyan]{origin}[/] e [cyan]{destination}[/]...")
        ...
        # Controle de polling
        last_poll_time = 0
        poll_interval = 3  # Intervalar de polling em segundos
        op_status = None
        ...
        try:
            ...
            while True:
                ...
                # Verificar se é hora de fazer polling (a cada 3 segundos)
...
def generate_map(
    ...
    # Usar o endpoint assíncrono
    console.print("[bold green]Iniciando geração do mapa...")
    try:
        # Iniciar operação assíncrona
        response = httpx.post(
        ...
        # Indicação clara de início da operação
        console.print(f"[bold green]Gerando mapa linear entre [cyan]{origin}[/] e [cyan]{destination}[/]...")
